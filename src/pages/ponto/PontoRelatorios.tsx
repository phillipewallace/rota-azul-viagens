...
const reports: { id: ReportId; title: string; desc: string; icon: any; tint: string; accent: string; legal: string }[] = [
  ...
  { id: 'espelho', title: 'Espelho de Ponto (PDF)', desc: 'PDF oficial completo, em várias páginas, com espelho individual de cada funcionário com jornada vinculada.', icon: FileText, tint: 'from-sky-500/10', accent: 'bg-sky-500', legal: 'CLT art. 74' },
      ...
      switch (id) {
        ...
        case 'espelho': {
          ...
          const res = generateEspelhoConsolidadoPdf({
            empresa, employees: EMPLOYEES, jornadas: JORNADAS, punches: PUNCHES, justifications: JUSTIFICATIONS, from, to,
